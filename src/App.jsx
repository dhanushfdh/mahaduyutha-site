      ...
      <div>
        ...
        <ul className="space-y-3 text-sm text-slate-400">
          ...
          <li className="flex items-center gap-2">
            ...
            <a href="mailto:mahadhyuthaacoustic@gmail.com" className="hover:text-blue-300 transition-colors">mahadhyuthaacoustic@gmail.com</a>
          </li>
          <li className="flex items-center gap-2">
        ...
        <div className="space-y-8">
          ...
          <div className="flex items-center gap-5 group">
            ...
            <div>
              ...
              <a href="mailto:mahadhyuthaacoustic@gmail.com" className="text-white font-medium text-[15px] hover:text-blue-300 transition-colors">
                mahadhyuthaacoustic@gmail.com
              </a>
            </div>
          </div>
        </div>
