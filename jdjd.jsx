    ...
    <>
      <header className="flex items-center justify-between px-8 py-6 max-w-7xl mx-auto w-full border-b border-white/5 backdrop-blur-sm sticky top-0 z-50">
        ...
        >
          ...
          <span className="text-white font-semibold tracking-widest text-sm uppercase group-hover:text-blue-200 transition-colors">MAHADHYUTHA</span>
        </button>
      ...
      >
        ...
        <div className="mt-auto space-y-4 pt-8">
          ...
          <div className="flex items-center justify-center space-x-4">
             <a href="tel:+916363146633" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-blue-300 hover:bg-blue-500/20 transition-colors">
               <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
             </a>
             <a href="mailto:info@mahadhyutha.in" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-blue-300 hover:bg-blue-500/20 transition-colors">
    ...
    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
      ...
      <div>
        ...
        <div className="flex space-x-3">
          <a href="https://www.facebook.com/share/1HtXr1CVPh/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-blue-500/20 hover:border-blue-500/30 text-slate-400 hover:text-white transition-all">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M22.675 0h-21.35c-.732 0-1.325.593-1.325 1.325v21.351c0 .731.593 1.324 1.325 1.324h11.495v-9.294h-3.128v-3.622h3.128v-2.671c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12v9.293h6.116c.73 0 1.323-.593 1.323-1.325v-21.35c0-.732-.593-1.325-1.325-1.325z"/></svg>
          </a>
          <a href="https://www.instagram.com/mahadhyutha_acoustic" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-blue-500/20 hover:border-blue-500/30 text-slate-400 hover:text-white transition-all">
          ...
          <a href="http://www.linkedin.com/in/mahadhyutha-acoustic-05b5593b8" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-blue-500/20 hover:border-blue-500/30 text-slate-400 hover:text-white transition-all">
...
const Hero = ({ setCurrentView }) => (
  <div className="w-full flex flex-col items-center justify-center animate-[fadeIn_0.5s_ease-out] relative z-20">
    <div className="glass-panel rounded-[2.5rem] p-10 md:p-16 lg:p-20 max-w-5xl mx-auto w-full text-center relative overflow-hidden shadow-2xl">
      {/* Soft Lighting Reflections inside the glass panel */}
      <div className="absolute -top-32 -left-32 w-96 h-96 bg-blue-500/20 rounded-full blur-[100px] pointer-events-none"></div>
      <div className="absolute -bottom-32 -right-32 w-96 h-96 bg-cyan-500/20 rounded-full blur-[100px] pointer-events-none"></div>
      
      <div className="relative z-10">
        <div className="inline-flex items-center space-x-2 px-4 py-1.5 rounded-full border border-white/20 bg-white/5 backdrop-blur-md mb-8 shadow-lg">
          <span className="w-2 h-2 rounded-full bg-blue-400 animate-pulse"></span>
          <span className="text-xs font-semibold tracking-widest text-slate-200 uppercase">MAHADHYUTHA Acoustic</span>
        </div>
        
        <h1 className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold tracking-tight text-white leading-[1.15] drop-shadow-2xl mb-8">
          Premium Acoustic Solutions <br className="hidden lg:block" />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 via-white to-slate-400">
            for Modern Spaces
          </span>
        </h1>
        
        <p className="text-lg md:text-xl font-light text-slate-300 max-w-3xl mx-auto leading-relaxed drop-shadow-lg mb-12">
          High-performance acoustic panels, ceiling baffles and architectural sound solutions designed for offices, auditoriums and commercial interiors.
        </p>
        
        <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-5">
          <button 
            onClick={() => setCurrentView('product')}
            className="group relative px-8 py-4 bg-white text-slate-950 font-bold tracking-wide rounded-full overflow-hidden transition-all hover:scale-105 active:scale-95 w-full sm:w-auto shadow-[0_0_40px_-10px_rgba(255,255,255,0.5)]"
          >
          ...
          <button 
            ...
            className="px-8 py-4 bg-white/10 text-white font-bold tracking-wide rounded-full border border-white/20 backdrop-blur-md transition-all hover:bg-white/20 hover:border-white/30 hover:shadow-xl w-full sm:w-auto flex items-center justify-center space-x-2"
          >
            <span>Contact Us</span>
            <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
          </button>
          <button className="px-8 py-4 bg-transparent text-blue-300 font-bold tracking-wide rounded-full border border-blue-500/30 hover:bg-blue-500/10 transition-all w-full sm:w-auto flex items-center justify-center space-x-2">
    ...
    {/* Glass UI Metrics Panel */}
    <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 w-full max-w-5xl mx-auto">
      <div className="glass-panel rounded-2xl p-6 text-center hover:bg-white/5 transition-colors">
        <h4 className="text-3xl font-bold text-white drop-shadow-md">100%</h4>
        <p className="text-xs text-slate-400 uppercase tracking-wider mt-2 font-medium">PET Fiber Core</p>
      </div>
      <div className="glass-panel rounded-2xl p-6 text-center hover:bg-white/5 transition-colors">
        <h4 className="text-3xl font-bold text-white drop-shadow-md">Class A</h4>
        <p className="text-xs text-slate-400 uppercase tracking-wider mt-2 font-medium">Fire Rating</p>
      </div>
      <div className="glass-panel rounded-2xl p-6 text-center hover:bg-white/5 transition-colors">
        <h4 className="text-3xl font-bold text-white drop-shadow-md">148+</h4>
        <p className="text-xs text-slate-400 uppercase tracking-wider mt-2 font-medium">Color Options</p>
      </div>
      <div className="glass-panel rounded-2xl p-6 text-center hover:bg-white/5 transition-colors">
        <h4 className="text-3xl font-bold text-white drop-shadow-md">0.70</h4>
        <p className="text-xs text-slate-400 uppercase tracking-wider mt-2 font-medium">Up to NRC</p>
      </div>
    </div>
  </div>
);
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
      ...
      <div className="lg:col-span-5 flex flex-col justify-center space-y-8">
        ...
        <div className="pt-4 flex flex-col sm:flex-row gap-4">
           ...
           <button className="w-full sm:w-auto bg-blue-500/10 text-blue-300 px-8 py-4 rounded-xl font-bold tracking-tight border border-blue-500/30 hover:bg-blue-500/20 transition-colors flex items-center justify-center gap-2">
             <svg className="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
             <span>Download Product Catalogue</span>
           </button>
        </div>
  ...
  <main className="flex-1 max-w-7xl mx-auto w-full px-6 pt-12 pb-24 text-slate-300 animate-[fadeIn_0.5s_ease-out]">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
      ...
      <div className="space-y-8">
        <div>
          <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-6">About <br/><span className="text-blue-200">MAHADHYUTHA</span></h1>
          <div className="w-20 h-1 bg-blue-500/50 rounded-full mb-8"></div>
        </div>
        
        <div className="space-y-6 text-lg text-slate-400 leading-relaxed">
          <p>
            MAHADHYUTHA was established with a vision to offer world-class materials that elevate spaces to new lifestyle standards. Our product range is carefully crafted to meet the versatile demands of modern environments, combining functional design with aesthetic appeal.
          </p>
          <p>
            Each MAHADHYUTHA product introduces an element of sophistication, transforming spaces with ease and elegance.
          </p>
          <p>
            As a privately owned and fully integrated organization, MAHADHYUTHA manufactures, markets, and distributes premium building materials worldwide. Our extensive global network of partners supports our mission to bring exceptional materials to every corner of the world, ensuring seamless availability, sales, and service.
          </p>
        </div>
      </div>
        ...
        <div className="space-y-8 relative z-10">
          ...
          <div className="flex items-start space-x-4 group">
            ...
            <div>
              ...
              <a href="tel:+916363146633" className="text-white font-medium hover:text-blue-300 transition-colors">+91 63631 46633</a>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4 group">
            ...
            <div>
              ...
              <a href="https://wa.me/c/919230972657" className="text-white font-medium hover:text-green-400 transition-colors">+91 63631 46633</a>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4 group">
            ...
            <div>
              ...
              <a href="mailto:info@mahadhyutha.in" className="text-white font-medium hover:text-blue-300 transition-colors">info@mahadhyutha.in</a>
            </div>
          </div>
...
const App = () => {
  ...
  useEffect(() => {
    ...
    metaDesc.content = "Premium Acoustic Panels and Ceiling Systems designed for modern interiors. Elevate spaces to new lifestyle standards with MAHADHYUTHA.";
    ...
    metaKeywords.content = "Acoustic Panels, Ceiling Systems, PET Panels, Baffle Ceiling, Modern Interiors, Architecture, Sound Absorption, MAHADHYUTHA";
  ...
  return (
    <div className="relative min-h-screen flex flex-col bg-slate-950 font-sans overflow-x-hidden selection:bg-blue-500/30">
      ...
      <a 
        href="https://wa.me/c/919230972657" 
        target="_blank" 
